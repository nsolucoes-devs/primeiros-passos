    ...
    <section class="wrapper">
        <nav aria-label="breadcrumb" style="margin-bottom: -25px; margin-top: 20px;">
            <ol class="breadcrumb" style="margin: 0; padding: 0; background-color: transparent">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url('admin/adminopcoes/opcoes') ?>">Opções</a></li>
            </ol>
        </nav>
        <div class="c-card">
            <div class="c-card-header">
                <div class="row">
                    <div class="col-md-6 text-left">
                        <h2 style="color: #1b9045;"><b>Listagem de Opções</b></h2>
                    </div>
                    <form action="<?php echo base_url('admin/adminopcoes/opcoes') ?>" method="post">
                    <div class="col-md-6">
            ...
            <div class="c-card-body">
                <div class="table-responsive" style="width: 100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo ucwords(mb_strtolower($o['opcao_nome'])); ?></td>
                            <td><?php echo ucwords(mb_strtolower($o['opcao_categoria'])) ?></td>
                            <td style="color: #1b9045; font-size: 22px!important" class="text-center">
			                    <a onclick="verMarca(<?php echo $o['opcao_id']; ?>, '<?php echo $o['opcao_nome']; ?>', '<?php echo $o['opcao_categoria']; ?>')" style="color: #1b9045;" data-toggle="modal" data-target="#marca_vermodal"><i class="fa fa-eye" aria-hidden="true"></i></a>
			                    <a onclick="editarMarca(<?php echo $o['opcao_id']; ?>, '<?php echo $o['opcao_nome']; ?>', '<?php echo $o['opcao_categoria']; ?>')" style="color: #1b9045;" data-toggle="modal" data-target="#marca_editarmodal"><i style="padding-left: 12px;" class="fa fa-pencil" aria-hidden="true"></i></a>
			                    <i onclick="excluirMarca(<?php echo $o['opcao_id']; ?>)" data-toggle="modal" data-target="#marca_excluirmodal" style="padding-left: 12px; color: #1b9045" class="fa fa-trash" aria-hidden="true"></i>
    			            </td>
			            </tr>   
			            <?php } ?>
                    </tbody>
...
<div class="modal" tabindex="-1" role="dialog" id="marca_excluirmodal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('admin/adminopcoes/excluirOpcao') ?>" method="post">
          <input type="hidden" id="id_excluir" name="id_excluir">
          <div class="modal-body">
              <p style="font-size: 17px;"><b> Deseja excluir a opção? </b><p>
          </div>
...
<div class="modal fade" id="marca_adicionarmodal" tabindex="-1" role="dialog" aria-labelledby="marca_adicionarmodal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('admin/adminopcoes/insertOpcao') ?>" method="post">
          <div class="modal-body">
            <div class="row">
...
<div class="modal fade" id="marca_editarmodal" tabindex="-1" role="dialog" aria-labelledby="marca_editarmodal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background: linear-gradient(90deg, rgba(27, 144, 69) 0%, rgba(36, 189, 91) 70%);">
        <h4 class="modal-title" style="color: white; display: inline;">EDITAR OPÇÃO</h4>
        <button type="button" style="color: white" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?php echo base_url('admin/adminopcoes/updateOpcao') ?>" method="post">
          ...
          <div class="modal-body">
                 ...
                 <div class="row">
                     <div class="col-md-12 form-group">
                        <label><b>Categória: </b></label>
                        <input type="text" id="editarCategoria" name="editarCategoria" class="form-control" value="" required>
                     </div>    
                 </div>
          </div>
          <div class="modal-footer">
...
<div class="modal fade" id="marca_vermodal" tabindex="-1" role="dialog" aria-labelledby="marca_vermodal" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background: linear-gradient(90deg, rgba(27, 144, 69) 0%, rgba(36, 189, 91) 70%);">
        <h4 class="modal-title" style="color: white; display: inline;">OPÇÃO</h4>
        <button type="button" style="color: white" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
          ...
          <div class="modal-body">
                 ...
                 <div class="row">
                     <div class="col-md-12 form-group">
                        <label><b>Categória: </b></label>
                        <input type="text" id="verCategoria" name="verCategoria" class="form-control" value="" readonly>
                     </div>    
                 </div>
          </div>
          <div class="modal-footer">
    ...
    $(document).ready(function(){
        <?php if(isset($alert)){ ?>
            ...
            <?php } elseif($alert == 2) { ?>
                ...
                Toast2.fire({
                    icon: 'success',
                    title: 'Opção editada com sucesso!'
                })
            <?php } elseif($alert == 3) { ?>
                const Toast2 = Swal.mixin({
                    toast: true,
            ...
            <?php } elseif($alert == 4) { ?>
                ...
                Toast2.fire({
                    icon: 'error',
                    title: 'Não foi possível excluir a opção, pois a senha está incorreta. Resta Apenas ' + <?php if($this->session->userdata('user_block') == 2) { echo ' 1 ';} else { echo ' 2 '; } ?> + ' tentativa(s)!'
                })
            <?php } } 
            ...
            if(isset($produtosmarca)) { ?>
                ...
                Toast2.fire({
                    icon: 'error',
                    title: 'Não é possível excluir opção com produto(s) relacionado(s): <br><?php echo $produtosmarca; ?>', 
                })
            <?php } ?>
    });
</script>
...
<script>
    function editarMarca(id, nome, categoria){
        $('#id_editar').val(id);
        $('#editarNome').val(nome);
        $('#editarCategoria').val(categoria);
    }
    
    function verMarca(id, nome, categoria){
        $('#id_ver').val(id);
        $('#verNome').val(nome);
        $('#verCategoria').val(categoria);
    }
</script>
