            ...
            <div class="c-card">
                <div class="c-card-header">
                    <div class="row">
                        <div class="col-md-6 text-left">
                            <h2 style="color: #1b9045;"><b>Visualizar Tipo de Usuário</b></h2>
                        </div>
                        <div class="col-md-6">
                            <a href="<?php echo base_url('13858aeb4c9a5807927c7b952dace1fb') ?>"><i style="margin-top: 10px; border: 1px solid #3a0b0c; padding: 7px; border-radius: 5px; background-color: #1b9045; font-size: 17px; color: white" class="fa fa-reply" aria-hidden="true">VOLTAR</i></a>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            <input class="form-check-input" type="checkbox" value="1" id="fornecedores" name="fornecedores" disabled>
                            <label class="form-check-label" for="fornecedores"><b>Fornecedores</b></label>
                        </div>
                        <div class="col-md-2">
                            <input class="form-check-input" type="checkbox" value="1" id="funcionarios" name="funcionarios" disabled>
                            <label class="form-check-label" for="funcionarios"><b>Funcionários</b></label>
                        </div>
                        <div class="col-md-2">
                            <input class="form-check-input" type="checkbox" value="1" id="estoque" name="estoque" disabled>
                            <label class="form-check-label" for="estoque"><b>Estoque</b></label>
                        </div>
                        <div class="col-md-2">
                            <input class="form-check-input" type="checkbox" value="1" id="caixa" name="caixa" disabled>
