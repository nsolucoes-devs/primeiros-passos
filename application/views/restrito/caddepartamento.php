        ...
        <div class="c-card">
            <div class="c-card-header">
                <div class="col-md-6 text-left">
                    <h2 style="color: green;"><b>Adicionar Departamento</b></h2>
                </div>
            </div>
            <form id="form" action="<?php echo base_url('f0231933a4d275da05d89ed935d5d9f3');?>" method="post">
                            ...
                            <div id="detalhes" style="display: none">
                                ...
                                <div class="row" style="margin-top: 2%">
                                    ...
                                    <div class="col-md-4 form-group" style="margin-top: 30px;">
                                        ...
                                        <input type="checkbox" name="onmenu" id="onmenu" value="1">
                                    </div>
                                </div>
                            </div>
