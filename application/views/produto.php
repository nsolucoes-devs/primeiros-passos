                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        <ol class="carousel-indicators" style="position: absolute; top: -28px;left: -20%; width: 20%;">
                                            <div style="cursor: pointer; padding-right: 8px; position: absolute; top: 0; left: 10px;">
                                                <?php if ($produto) { ?>
                                                    <img onclick="trocaimagem(0)" class="d-block w-100" style="height: <?php if ($mobile == 1) {
                                                                                                                            echo '40';
                                                                                                                        } else {
                                                                                                                            echo '70';
                                                                                                                        }; ?>px!important; width: 70px!important; border: 1px solid lightgrey!important; border-radius: 5px!important;" src="<?php echo base_url('imagens/produtos/' . $produto['produto_id'] . '.jpg') ?>">
                                                <?php } ?>
                                            </div>
                                            <?php $x = 73;
                                            for ($i = 1; $i <= 4; $i++) { ?>
                                                <?php if ($produto) { ?>
                                                    <?php if ($produto['produto_imagens_opcional' . $i]) { ?>
                                                        <div style="cursor: pointer; padding-right: 8px; position: absolute; top: <?php echo $x;
                                                                                                                                    $x = $x + 73; ?>px; left: 10px;">
                                                            <img onclick="trocaimagem(<?php echo $i; ?>)" class="d-block w-100" style="height: <?php if ($mobile == 1) {
                                                                                                                                                    echo '40';
                                                                                                                                                } else {
                                                                                                                                                    echo '70';
                                                                                                                                                }; ?>px!important; width: 70px!important; border: 1px solid lightgrey!important; border-radius: 5px!important;" src="<?php echo base_url() . $produto['produto_imagens_opcional' . $i] ?>">
                                                        </div>
                                                    <?php } ?>
                                                <?php } ?>
                                            <?php } ?>
            ...
            if ($produto['produto_detalhes'] != '<p><br></p>') { ?>
                <div class="container">
                    <div class="row" style="width: 100%; padding: 0!important; margin: 0; margin-top: 4%; margin-bottom: 2%;">
                        <div class="col-md-12">
                            <h4 style="text-align: underline">Detalhes do Produto:</h4>
        ...
        <div class="container">
            <div class="row" style="width: 100%!important; margin-bottom: 5%!important; padding: 0; margin: 0">
                <div class="col-md-12 form-group" style="padding: 30px; margin: 0">
                    <h4 style="text-align: underline">Você pode se interessar também:</h4>
                </div>
