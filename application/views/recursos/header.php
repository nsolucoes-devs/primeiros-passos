...
<body>
  <style>
    ...
    .icones-header:hover i,
    .icones-header:hover,
    .icones-header:hover span {
  ...
  <header class="header-area">
    ...
    <div class="top-header-area" style="background: var(--base-color);">
      ...
      <!-- Top Contact Info -->
      <div class="top-contact-info d-flex align-items-center" style="<?php if ($mobile == 0) {
                                                                        echo 'margin-top:  -5px;';
                                                                      } ?>">
        <?php if ($mobile == 0) { ?>
    ...
    <div class="credit-main-menu" id="sticker">
      <div class="classy-nav-container breakpoint-off" style="width: 100%!important;">
        <div class="text-center">
          <!-- Menu -->
          <nav class="classy-navbar justify-content-between" id="creditNav" <?php if ($mobile == 1) {
                                                                              echo 'style="height: 0px !important;"';
                                                                            } ?>>
            ...
            <?php } else { ?>
              ...
              <div class="classy-menu mx-auto d-flex flex-column justify-content-between">
                ...
                <div class="d-flex p-2 align-items-center" style="background-color: var(--base-color);">
                  ...
                  <a href="tel:<?= $telefone ?>" class="text-center text-white "><?= mascararNumero($telefone, 'telefone'); ?></a>
