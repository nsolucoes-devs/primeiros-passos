    ...
    <body style="background: #f7f7f7;">
      <section id="container">
            ...
            <header class="header" style="height: 75px; background: black;">
                <div class="row">
                    <div class="col-md-5" style="margin-top: 5px; height: 75px; ">
                        <img style="height: 90%; width: auto; margin-top: -5px;" src="<?php echo base_url('/imagens/site/logo.png')?>" alt="">
                    </div>
                                        ...
                                        <div class="custom-drop">
                                            <div class="drop-content">
                                                ...
                                                <?php if($perm['perfilusuario_promocao'] == 1 || $super == 1) { ?>
                                                    <a href="<?php echo base_url('0216886b85e598a495cf53b303ec5b54') ?>"><p class="bb">Promoções</p></a>
                                                <?php } ?>
                ...
                <?php if($this->session->userdata('sorteio') == 0){ ?>
                    ...
                    <div>
                        ...
                        <div class="hide-opt-menu">
                            <?php if($perm['perfilusuario_produto'] == 1 || $super == 1){ ?>
                            <a href="<?php echo base_url('391a027a8fef2eba4487a00156901156') ?>"><p>PRODUTOS</p></a>
                            <?php } ?>
                            <?php if($perm['perfilusuario_departamento'] == 1 || $super == 1){ ?>
                            <a href="<?php echo base_url('48b6bbfcf12b55d9b0e4c2ded7384bff') ?>"><p>DEPARTAMENTOS</p></a>
                            <?php } ?>
                            <?php if($perm['perfilusuario_promocao'] == 1 || $super == 1){ ?> 
                    ...
                    <div>
                        ...
                        <div class="hide-opt-menu">
                            ...
                            <a href="<?php echo base_url('e12424b582344b74d442de7107c91fd9') ?>"><p>relatorios</p></a>
                            <?php } ?>
                        </div>
                    </div>
                    <?php } ?>
